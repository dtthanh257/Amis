...
import { BASE_API_URL } from "@/helper/base_url";
class EmployeeService {
    ...
    async getEmployeeCode() {
            return await axios({
                method: "get",
                url: BASE_API_URL +" v1/Employees/NewEmployeeCode",
            });
        }
        /**
    ...
    async updateEmployee(id, data) {
            return await axios({
                method: "put",
                url: BASE_API_URL +" v1/Employees/" + id,
                headers: {
                    accepts: "*/*",
                    "Content-Type": "application/json-patch+json",
                },
 ...
 */
    ...
    async filterEmployee(key) {
        return await axios({
            method: "get",
            url: BASE_API_URL +" v1/Employees/filter?employeeFilter=" +
                key,
            headers: {
                accepts: "*/*",
                "Content-Type": "application/json-patch+json",
